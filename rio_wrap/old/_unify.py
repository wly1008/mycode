...
from mycode.rio_wrap import reproject as _reproject
from . import SetNodataWarning
...
def _unify(raster_in, dst_in=None, out_path=None,
    ...
    **creation_options : TYPE
    ...
    try:
        ...
        args = e.args
        args = args + ('可能是nodata与栅格dtype不匹配, 可用nodata、dtype(在**creation_options中)参数设置转换',)
