...
import pathlib,os
import numpy as np
from mycode.rio_wrap._unify import _unify
from mycode.rio_wrap.reproject import reproject
...
def unify(raster_in,dst_in=None,out_path=None,
    ...
    with ExitStack() as stack:
        ...
        if Double_operation:
            ...
            raster_in = _unify(raster_in, dst_in=dst_in,out_path=_temp_ph1,
        ...
        if src_crs == crs:
            ...
            if src_size == size:
                # ds = src
                delete = '!True' if Double_operation else False
